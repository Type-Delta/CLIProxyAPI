...
**Recorded validation:** the exact Bun 1.3.14 canonical builder produces SHA-256 `c73d375efa0b75ed12905cee9d825ba08a9dac6d8f01226e4969233311f62fa2` from CPAMC `ad545f441c47563efe2c639003600341c337cab3`. Earlier main-image, cached `--network=none`, Nginx image, mutable artifact, bundled fallback, workflow, and cross-build checks passed for the preceding implementation pin. CI remains authoritative for native CGO and plugin builds.
