...
func TestDetectClaudeCodeRequestClassifiesEntrypoints(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{name: "sdk", userAgent: "claude-cli/2.1.258 (external, sdk)", entrypoint: "sdk", subclient: "claude-code-sdk", native: true},
		...
		{name: "sdk-py", userAgent: "claude-cli/2.1.258 (external, sdk-py, agent-sdk/0.1.0)", entrypoint: "sdk-py", subclient: "claude-code-sdk-py", agentSDKVersion: "0.1.0", native: true},
		{name: "desktop", userAgent: "claude-cli/2.1.258 (external, claude-desktop)", entrypoint: "claude-desktop", subclient: "claude-desktop", native: true},
