...
var zhStrings = map[string]string{
	...
	"key_usage_reset":         "已重置 API Key 用量",
	"confirm_reset_key_usage": "⚠ 重置 %s 的用量? [y/n]",
	"limits_unavailable":      "⚠ 无法加载用量限制: %s",
	...
	"key_form_key":                 "密钥",
	"key_form_label":               "标签",
	"key_form_label_optional":      "(可选，留空清除)",
	"key_form_label_json_toggle":   "Ctrl+J 切换 JSON 输入",
	"key_form_label_json_mode":     "JSON 字符串；Ctrl+J 切回普通输入",
	"key_form_label_invalid_json":  "标签必须是有效的 JSON 字符串",
	"key_form_label_json_required": "含控制字符的标签需要 JSON 输入模式",
...
var enStrings = map[string]string{
	...
	"key_usage_reset":         "API key usage reset",
	"confirm_reset_key_usage": "⚠ Reset usage for %s? [y/n]",
	"limits_unavailable":      "⚠ Usage limit data unavailable: %s",
	...
	"key_form_key":                 "Key",
	"key_form_label":               "Label",
	"key_form_label_optional":      "(optional; blank clears)",
	"key_form_label_json_toggle":   "Ctrl+J for JSON input",
	"key_form_label_json_mode":     "JSON string; Ctrl+J for plain input",
	"key_form_label_invalid_json":  "label must be a valid JSON string",
	"key_form_label_json_required": "labels with control characters require JSON mode",
